...
namespace Zeckoxe.Vulkan.Toolkit
{
    ...
    //        private PixelFormat GetFormatDDPFRGB24() => PixelFormat.Undefined; // No 24bpp DXGI formats aka D3DFMT_R8G8B8
    ...
    //        private PixelFormat GetFormatDDPFAlpha() => 8 == this.RGBBitCount ? PixelFormat.Undefined : PixelFormat.Undefined;
